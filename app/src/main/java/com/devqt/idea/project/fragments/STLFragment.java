...
public class STLFragment extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stl_frament);
        ...
        myRef = database.getReference("stl");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<ItemsModel, STLFragment.BlogViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<ItemsModel, STLFragment.BlogViewHolder>(
                        ItemsModel.class,
                        R.layout.elements_row,
                        STLFragment.BlogViewHolder.class,
                        myRef)  {



                    @Override
                    protected void populateViewHolder(STLFragment.BlogViewHolder viewHolder, ItemsModel model, int position) {
    ...
    private void signOut()
    {
        ...
        Intent intent = new Intent(STLFragment.this, LogIn.class);
